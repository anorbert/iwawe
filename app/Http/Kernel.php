...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'daf' => \App\Http\Middleware\DAFMiddleware::class,
        'accountant' => \App\Http\Middleware\AccountantMiddleware::class,
        'datamanager' => \App\Http\Middleware\DataManagerMiddleware::class,
        'schememanager' => \App\Http\Middleware\SchemeManagerMiddleware::class,
        'humanresource' => \App\Http\Middleware\HumanResourceMiddleware::class,
    ];
}
